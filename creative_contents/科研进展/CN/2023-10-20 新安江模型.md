<h2 style='pointer-events: none;'>新安江模型</h3>

各函数功能详情请翻阅2023-10-12的进展 
<h3 style='pointer-events: none;'>1准备</h3>

输入包并导入数据，数据可从水文工具板块的新安江模型中下载
```
import numpy as np
import pandas as pd
...
```
<h3 style='pointer-events: none;'>2产流模型</h3>
<h4 style='pointer-events: none;'>边界条件</h4>

ModelConceptional.xaj_function这里为装函数的文件
```
...
```
<h4 style='pointer-events: none;'>产流模型参数</h4>
...
IM = 0.01
```
<h4 style='pointer-events: none;'>产流计算</h4>
...
```
<h3 style='pointer-events: none;'>3汇流模型</h3>
...
```
<h4 style='pointer-events: none;'>汇流模型参数</h4>
...
U = F / (3.6 * time_lag)
```
<h4 style='pointer-events: none;'>汇流计算</h4>
